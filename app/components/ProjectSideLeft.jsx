    ...
    return(
        <div className="lg:flex">
            <div className="grid grid-cols-12">
                <div className="flex flex-col lg:col-span-4 col-span-12 order-2 lg:order-1 text-white mr-9">
                ...
                <a href={data.url} className="lg:col-span-8 col-span-12 order-1 lg:oreder-2">
                    <div className="relative img-warp">
                        ...
                        <div className=" hidden lg:block absolute -bottom-[65px] -left-[65px]" style={{transform: `skewX(-50deg)`}}>
                            <MoreDetails/>
                        </div>
                    </div>
                </a>
